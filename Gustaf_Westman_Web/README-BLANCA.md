...
@media (max-width: 768px) {
    #unico-title {
        font-size: 10vw; /* Texto más pequeño en dispositivos móviles *gsap.registerPlugin(ScrollTrigger, ScrollSmoother);
...
const smoother = ScrollSmoother.create({
  content: "#gsap-slider", // Contenedor principal del contenido
  smooth: 1,               // Suaviza el scroll
  effects: true            // Habilita los efectos de ScrollTrigger con ScrollSmoother
});
